...
public class arcweaveLibrary : ModuleRules
{
	public arcweaveLibrary(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			RuntimeDependencies.Add("$(PluginDir)/Binaries/ThirdParty/arcweaveLibrary/Win64/ExampleLibrary.dll");
        }
