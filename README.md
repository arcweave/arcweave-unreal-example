...
1. Initialization: If you don't see anything in `ArcweaveDemo/Plugins/ArcweavePluginRepository` folder, run `git submodule update --init --recursive` to download the plugin files.
